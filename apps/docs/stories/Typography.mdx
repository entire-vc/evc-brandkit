...
<div className="space-y-4 my-8">
  ...
  <p>
    Run <code className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm">npm install @entire-vc/ui</code> to install.
  </p>
  
  <p className="text-sm text-muted-foreground mt-4">Code block:</p>
  <pre className="rounded-lg bg-muted p-4 overflow-x-auto">
    <code className="font-mono text-sm">{`import { Button } from '@entire-vc/ui';
